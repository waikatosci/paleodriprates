...
| `HS4_composite.jpg` / `.json` | `companion_analysis/hs4_composite/si_figures.py` (Supp Figs 21–22) | photographic composite of the polished section, 100 px/cm on the pencil depth scale (row 0 = 0 cm; scale line at column 1650; white = no stone), stitched from eight DSLR photographs (C. Hu) by `companion_analysis/hs4_composite/build_composite.py` |
| `HS4_axial_slice.jpg` / `.json` | Fig 5c | 6 cm wide slice of the composite (−7 to −1 cm from the scale line), rows = depth at 100 px/cm; cut by `build_composite.py` |
