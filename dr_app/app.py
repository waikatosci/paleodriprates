...
const ELEM_DEFAULTS = {
  'Ni': { Kd_mn: -3.9361940015, Kd_sd: 1.282549830161864, F: 0.01, InertF: 0.10, aq_conc: 4.370005432, K_e: 1.0 },
  'Co': { Kd_mn: -5.5162692714, Kd_sd: 1.282549830161864, F: 0.01, InertF: 0.40, aq_conc: 0.460490861, K_e: 1.0 },
